                            ...
                            <div class="modal-body">
                                <form id="ItemForm" name="ItemForm" class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" id="category" name="category" required="" placeholder="Enter Category" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('body').on('click', '.editItem', function () {
                ...
                $.get("{{ route('ajaxItems.store') }}" +'/' + Item_id +'/edit', function (data) {
            ...
            $('body').on('click', '.deleteItem', function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ url('ajaxItems/destroy') }}"+'/'+Item_id,
                    success: function (data) {
                        table.draw();
                    },
                    error: function (data) {
